...
public class ModelFallenAngel extends ModelBase {
	...
	public ModelFallenAngel() {
		...
		this.setRotateAngle(wingBoneBase, 0.27314402793711257F, -0.5462880558742251F, -0.6373942428283291F);
		this.wingBoneSecond_1 = new ModelRenderer(this, 31, 38);
		this.wingBoneSecond_1.setRotationPoint(14.3F, 0.8F, 0.7F);
		this.wingBoneSecond_1.addBox(0.0F, -1.0F, -1.0F, 15, 2, 2, 0.0F);
		this.setRotateAngle(wingBoneSecond_1, 0.0F, -1.2292353921796064F, 0.0F);
		...
		this.wingFlap_1.setRotationPoint(7.0F, 0.6F, 1.0F);
		...
		this.wingFlap3_1.addBox(0.0F, 0.0F, 0.0F, 9, 10, 0, 0.0F);
		this.wingFlap2_1 = new ModelRenderer(this, 34, 10);
		this.wingFlap2_1.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.wingFlap2_1.addBox(0.0F, 0.0F, 0.0F, 15, 10, 0, 0.0F);
		...
		this.wingBoneThird_1.setRotationPoint(14.3F, 0.0F, 0.0F);
		this.wingBoneThird_1.addBox(0.0F, -1.0F, -1.0F, 9, 2, 2, 0.0F);
		this.setRotateAngle(wingBoneThird_1, 0.0F, -0.5009094953223726F, -0.091106186954104F);
		...
		this.wingBoneBase_1.setRotationPoint(1.0F, 1.8F, 2.0F);
		this.wingBoneBase_1.addBox(0.0F, 0.0F, 0.0F, 15, 2, 2, 0.0F);
		this.setRotateAngle(wingBoneBase_1, -0.091106186954104F, -2.7317893452215247F, 0.6829473363053812F);
